...
window.CampoGestorTelas.mais = function() {
  ...
  <div class="page-actions">
    <button type="button" class="btn" data-edit="farm">Editar fazenda</button>
  </div>`;
  ...
  html += `<div class="card mais-card">
    ...
    <p class="muted">Troque o usuário pelo perfil no topo. Visitante é só consulta.</p>
    <button type="button" class="btn block" id="btn-reset" style="margin-top:.6rem">Restaurar cadastro oficial</button>
  </div>`;
  return html;
};
